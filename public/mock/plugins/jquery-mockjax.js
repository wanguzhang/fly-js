...
(function(root, factory) {
    ...
    function getMockForRequest(handler, requestSettings) {
        ...
        if ($.isFunction(handler.url.test)) {
            ...
            var namespace =
                handler.namespace ||
                (typeof handler.namespace === 'undefined' && $.mockjaxSettings.namespace);
            ...
            if (
                ...
                !new RegExp(
                    effecitveUrl.replace(/[-[\]{}()+?.,\\^$|#\s]/g, '\\$&').replace(/\*/g, '.+')
    ...
    function createJsonpCallback(requestSettings, mockHandler, origSettings) {
        var callbackContext = (origSettings && origSettings.context) || requestSettings;
        var jsonp =
            (typeof requestSettings.jsonpCallback === 'string' && requestSettings.jsonpCallback) ||
            'jsonp' + jsc++;
    ...
    var logger = {
        _log: function logger(mockHandler, args, level) {
            ...
            if ($.mockjaxSettings.log) {
                ...
                return $.mockjaxSettings.logger[$.mockjaxSettings.logLevelMethods[level]].apply(
                    $.mockjaxSettings.logger,
                    args
                );
            }
